RunSimulinkPkg MATLAB Python Package
...
RunSimulinkPkg. If you do not have write permissions, copy all its contents to a 
...
The RunSimulinkPkg package is on your Python path. To import it into a Python script or 
session, execute:
